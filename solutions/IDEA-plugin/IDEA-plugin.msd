...
<solution name="IDEA-plugin" uuid="98a10a84-50c2-46eb-8404-e3a3e592d9cc" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot contentPath="${module}" type="java_classes">
      <sourceRoot location="libs/HTTPClient.jar" />
    </modelRoot>
  </models>
  <stubModelEntries>
    <stubModelEntry path="/Users/skandy/workspace/HTTPTest/solutions/HTTPClient/libs/HTTPClient.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
